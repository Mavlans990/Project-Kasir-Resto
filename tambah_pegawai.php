            ...
            <form class="form-valide-with-icon needs-validation" method="post" >
              <div class="mb-3">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="nama_pegawai" id="validationCustomUsername" placeholder="Masukkan Nama .." required="">
                </div>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control" name="no_hp" id="validationCustomUsername" placeholder="Masukkan No Hp.." required="">
                </div>
              </div>
              <div class="col-lg-6 mb-2">
                ...
                <label class="radio-inline me-3">
                  <input class="form-check-input" type="radio" name="jenkel" value="Perempuan" > Perempuan
                </label>
              </div>
...
if (isset($_POST['simpan'])) {
  ...
  $sql = mysqli_query($koneksi, " INSERT INTO pegawai VALUES('', '$nama_pegawai', '$jenkel', '$alamat', '$no_hp')");
