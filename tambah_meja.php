        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tambah Data Meja</h4>
                </div>
                <div class="card-body">
                        ...
                        <form class="form-valide-with-icon needs-validation" method="post" >
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="nomor_meja" id="validationCustomUsername" placeholder="Masukkan No Meja.." required="">
...
if (isset($_POST['simpan'])) {
    ...
    $sql = mysqli_query($koneksi, " INSERT INTO meja VALUES('', '$nomor_meja', 'Kosong')");
