                    ...
                    <div class="row">
                      <div class="mb-3 col-md-6">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="nama_user" value="<?= $_SESSION['nama_user'] ?>" id="total"  readonly="" > 
                        </div>
                      </div>
                      <div class="mb-3 col-md-6">
...
if (isset($_POST['simpan'])) {
  ...
  $sql = mysqli_query($koneksi, " INSERT INTO transaksi VALUES( '$kode_transaksi', '$nama_user', '$id_menu', '$nomor_meja', '', '', '', '$jumlah_pesanan', '', '$jml_harga', '$total_hrg')");

   $sql2 = mysqli_query($koneksi, " INSERT INTO detail_transaksi VALUES('', '$kode_transaksi', '$nomor_meja', '$id_menu', '$jumlah_pesanan', '$total_hrg')");
