        ...
        <div class="card">
          <div class="card-header">
            <!-- <span class="badge-lg badge light badge-primary"> Dari Tanggal : <?= date('d F Y',strtotime($dari)) ?></span>
              ...
              <a href="<?= 'print_tanggal.php?dari=' . $dari . '&sampai=' . $sampai ?>" class="btn-sm btn me-2 btn-primary">Cetak</a>
            </div>
            <div class="card-body">
              ...
              <div class="col-lg-4 col-sm-5 ms-auto">
                <table class="table table-clear">
                  <tbody>
                    <tr>
                      <?php
                      $bayar = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT SUM(total_hrg) AS total FROM transaksi WHERE tgl_transaksi BETWEEN '$dari' AND '$sampai' "));
                      ?>
