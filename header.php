...
if (!isset($_SESSION['username'])) {
  ...
  ";
}elseif ($_SESSION['status']=="Tdk Aktif") {
    echo "
    <script>
    alert('Aktifkan Akun Anda Dahulu');
    window.location = 'login.php';
    </script>
    ";
}
...
<body>
    ...
    <!--**********************************
            ...
            <div class="nav-header">
            	<a href="index.php" class="brand-logo">
            		...
            		<div class="brand-title">
            			<h2 class="">Fillow.</h2>
            			<span class="brand-sub-title"><?= $_SESSION['nama_user'] . ' - ' . $_SESSION['level'] ?></span>
            		</div>
            	</a>
            				...
            				<ul class="navbar-nav header-right">
            					...
            					<li class="nav-item dropdown  header-profile">
            						...
            						<div class="dropdown-menu dropdown-menu-end">
            							...
            							<button type="button" class="dropdown-item ai-icon" data-bs-toggle="modal" data-bs-target="#basicModal">
            ...
            <div class="dlabnav">
            	<div class="dlabnav-scroll">
            		<ul class="metismenu" id="menu">
                        ...
                        <?php if ($_SESSION['level']=="Admin") { ?>
                            <li>
                                <a href="user.php" class="" aria-expanded="false">
                                   <i class="fas fa-address-card"></i>
                                   <span class="nav-text">User</span>
                               </a>
                           </li>
                       <li>
                        <a href="log_kasir.php" class="" aria-expanded="false">
                         <i class="fas fa-clipboard"></i>
                         <span class="nav-text">Log Kasir</span>
                     </a>
                 </li>
             <?php } ?>
             ...
             <?php if ($_SESSION['level']=="Kasir") { ?>
               <li>
                <a href="transaksi.php" class="" aria-expanded="false">
     ...
     <?php if ($_SESSION['level']=="Manajer") { ?>
        <li>
            <a href="menu_makanan.php" class="" aria-expanded="false">
       ...
       <li>
        ...
        <ul aria-expanded="false">
            <li><a href="laporan_tanggal.php">Laporan Tanggal</a></li>
            <li><a href="laporan_kasir.php">Laporan Kasir</a></li>
        </ul>
    </li>
<?php } ?>
...
<div class="copyright">
 <p><strong>Fillow Saas <?= $_SESSION['nama_user'] ?></strong> © 2021 All Rights Reserved</p>
            	...
            	<div class="modal-dialog" role="document">
            		<div class="modal-content">
            			<div class="modal-header">
            				<h5 class="modal-title"><?=  $_SESSION['nama_user'] . ' - ' . $_SESSION['level']?></h5>
            				<button type="button" class="btn-close" data-bs-dismiss="modal">
            				</button>
            			</div>
            			<div class="modal-body">Yakin Anda Ingin Keluar!</div>
            			<div class="modal-footer">
            				<button type="button" class="btn btn-danger light" data-bs-dismiss="modal">Close</button>
            				<a href="logout.php" class="btn btn-primary">Confirm</a>
            			</div>
            		</div>
            	</div>
            </div>
